...
- 每一个对象都有隐藏的 `[[prototype]]` 属性，该属性值为 `null` 或另一个对象的堆内存地址，这个对象被称为原型 (prototype)
...
![prototype and constructor properties](./images/prototype_constructor.png)
...
![instance's \[\[prototype\]\] property](./images/instance_prototype.png)

- 除了 Object 构造函数，其他内置构造函数的 `prototype` 对象的 `[[prototype]]` 指向 `Object.prototype`

![built-in constructor's \[\[prototype\]\]](./images/built_in_prototype.png)
