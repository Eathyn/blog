import{_ as n,o as s,c as a,a as t}from"./app.0a43b3c6.js";const e={},p=t(`<h1 id="type-modifiers" tabindex="-1"><a class="header-anchor" href="#type-modifiers" aria-hidden="true">#</a> Type Modifiers</h1><h2 id="top-types" tabindex="-1"><a class="header-anchor" href="#top-types" aria-hidden="true">#</a> Top Types</h2><ul><li>A top type, or universal type, is a type that can represent any possible value in a system.</li><li>All types are assignable to a top type.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> a<span class="token operator">:</span> <span class="token builtin">number</span> <span class="token operator">=</span> <span class="token number">1</span>
...
</code></pre></div><h3 id="any-again" tabindex="-1"><a class="header-anchor" href="#any-again" aria-hidden="true">#</a> any, Again</h3><ul><li>Using <code>any</code> type tells TypeScript not to perform type checking on that value&#39;s assignability or members.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> a<span class="token operator">:</span> <span class="token builtin">any</span> <span class="token operator">=</span> <span class="token number">1</span>
...
</code></pre></div><ul><li>If you want to indicate that a value can be anything, the <code>unknown</code> type is much safer.</li></ul><h3 id="unknown" tabindex="-1"><a class="header-anchor" href="#unknown" aria-hidden="true">#</a> unknown</h3><ul><li>TypeScript does not allow directly accessing properties of <code>unknown</code> typed value.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> a<span class="token operator">:</span> <span class="token builtin">unknown</span> <span class="token operator">=</span> <span class="token number">1</span>
...
</code></pre></div><ul><li>The <code>unknown</code> type value can&#39;t be assignable to types that are not a top type (<code>any</code> or <code>unknown</code>).</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> a<span class="token operator">:</span> <span class="token builtin">unknown</span> <span class="token operator">=</span> <span class="token number">1</span>
<span class="token comment">// ok</span>
...
</code></pre></div><ul><li>TypeScript will allow code to access members of <code>unknown</code> type value if the value&#39;s type is narrowed, such as <code>instanceof</code>, <code>typeof</code> or type assertion.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">fn</span><span class="token punctuation">(</span>a<span class="token operator">:</span> <span class="token builtin">unknown</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><p><em>compiled code:</em></p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">var</span> person <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><ul><li>TypeScript allows <code>keyof</code> and <code>typeof</code> to be chained together to succinctly retrieve the allowed keys on a value\u2019s type.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> person <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token string">&#39;eathyn&#39;</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token number">25</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
</code></pre></div><h2 id="type-assertions" tabindex="-1"><a class="header-anchor" href="#type-assertions" aria-hidden="true">#</a> Type Assertions</h2><ul><li>type assertion: override the type system\u2019s understanding of a value\u2019s type, also known as a \u201Ctype cast\u201D. TypeScript will defer to your assertion and treat the value as that type.</li><li>syntax: <code>as</code> keyword followed by a type</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> rawData <span class="token operator">=</span> <span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">[&#39;eathyn&#39;, &#39;eaven&#39;]</span><span class="token template-punctuation string">\`</span></span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="non-null-assertions" tabindex="-1"><a class="header-anchor" href="#non-null-assertions" aria-hidden="true">#</a> Non-Null Assertions</h3><ul><li>The <code>!</code> non-null assertion asserts that the type is not <code>null</code> or <code>undefined</code></li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// type: null | undefined | string</span>
...
</code></pre></div><ul><li>Non-null assertions are particularly useful with APIs such as <code>Map.get</code> that return a value or <code>undefined</code> if it doesn\u2019t exist.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> person <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Map</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
...
</code></pre></div><h3 id="type-assertion-caveats" tabindex="-1"><a class="header-anchor" href="#type-assertion-caveats" aria-hidden="true">#</a> Type Assertion Caveats</h3><ul><li>Like the <code>any</code> type, they should be avoided whenever reasonably possible.</li><li>It is often better to have more accurate types representing your code than it is to make it easier to assert on a value\u2019s type.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> person <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Map</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
  <span class="token punctuation">[</span><span class="token string">&#39;name&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;eathyn&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span><span class="token punctuation">)</span>
...
</code></pre></div><h4 id="assertion-assignability" tabindex="-1"><a class="header-anchor" href="#assertion-assignability" aria-hidden="true">#</a> Assertion assignability</h4><ul><li>TypeScript will only allow type assertions between two types if one of the types is assignable to the other.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// TS2352: Conversion of type &#39;string&#39; to type &#39;number&#39; may be a mistake because neither type sufficiently overlaps with the other.</span>
...
</code></pre></div><ul><li>If you absolutely must switch a value from one type to a totally unrelated type, you can use a double type assertion.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// type: number</span>
...
</code></pre></div><ul><li><code>as unknown as...</code> double type assertions are dangerous and almost always a sign of something incorrect in the types of the surrounding code.</li></ul><h2 id="const-assertions" tabindex="-1"><a class="header-anchor" href="#const-assertions" aria-hidden="true">#</a> Const Assertions</h2><ul><li>Arrays are treated as readonly tuples, not mutable arrays</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// type: readonly [1, 2, 3]</span>
...
</code></pre></div><h3 id="literals-to-primitives" tabindex="-1"><a class="header-anchor" href="#literals-to-primitives" aria-hidden="true">#</a> Literals to Primitives</h3><ul><li>Literals are treated as literals, not their general primitive equivalents.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// type: &#39;hello&#39;</span>
...
</code></pre></div><h3 id="read-only-objects" tabindex="-1"><a class="header-anchor" href="#read-only-objects" aria-hidden="true">#</a> Read-Only Objects</h3><ul><li>Properties on objects are considered readonly.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// type: { name: &#39;eathyn&#39; }</span>
...
</code></pre></div><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">fn</span><span class="token punctuation">(</span>value<span class="token operator">:</span> <span class="token string">&#39;yes&#39;</span> <span class="token operator">|</span> <span class="token string">&#39;no&#39;</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">string</span> <span class="token punctuation">{</span>
...
</code></pre></div>`,61),o=[p];function c(l,r){return s(),a("div",null,o)}const u=n(e,[["render",c],["__file","chapter_09.html.vue"]]);export{u as default};
