import{_ as n,o as s,c as a,a as t}from"./app.0a43b3c6.js";const p={},e=t(`<h1 id="classes" tabindex="-1"><a class="header-anchor" href="#classes" aria-hidden="true">#</a> Classes</h1><h2 id="class-methods" tabindex="-1"><a class="header-anchor" href="#class-methods" aria-hidden="true">#</a> Class Methods</h2><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
p<span class="token punctuation">.</span><span class="token function">greet</span><span class="token punctuation">(</span><span class="token string">&#39;smith&#39;</span><span class="token punctuation">)</span>
</code></pre></div><h2 id="class-properties" tabindex="-1"><a class="header-anchor" href="#class-properties" aria-hidden="true">#</a> Class Properties</h2><ul><li>If you want to access a property on a class in TypeScript, that property must be declared in the class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="function-properties" tabindex="-1"><a class="header-anchor" href="#function-properties" aria-hidden="true">#</a> Function Properties</h3><ul><li>The function is a property of the constructor&#39;s prototype.</li><li>The arrow function is a property of instance.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<span class="token keyword">new</span> <span class="token class-name">Custom</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>a<span class="token operator">?.</span>length
</code></pre></div><h3 id="read-only-properties" tabindex="-1"><a class="header-anchor" href="#read-only-properties" aria-hidden="true">#</a> Read-Only Properties</h3><ul><li><code>readonly</code> property cannot be modified except in the class constructor.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><ul><li>A readonly property without explicit type annotation will be inferred to their value&#39;s narrowed literal type if possible, rather than the wider primitive.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Custom</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="classes-as-types" tabindex="-1"><a class="header-anchor" href="#classes-as-types" aria-hidden="true">#</a> Classes as Types</h2><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="classes-and-interfaces" tabindex="-1"><a class="header-anchor" href="#classes-and-interfaces" aria-hidden="true">#</a> Classes and Interfaces</h2><ul><li>An instance of a class which implements one or more interfaces should be assignable to each of those interfaces.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Child</span> <span class="token keyword">implements</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="implementing-multiple-interfaces" tabindex="-1"><a class="header-anchor" href="#implementing-multiple-interfaces" aria-hidden="true">#</a> Implementing Multiple Interfaces</h3><ul><li>A class can implement multiple interfaces.</li><li>All properties and methods must be implemented in the class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">One</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Custom</span> <span class="token keyword">implements</span> <span class="token class-name">One</span><span class="token punctuation">,</span> Two <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><ul><li>TypeScript will throw error if a class implements multiple interfaces that has conflicting properties or methods.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">One</span> <span class="token punctuation">{</span>
  a<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="extending-a-class" tabindex="-1"><a class="header-anchor" href="#extending-a-class" aria-hidden="true">#</a> Extending a Class</h2><ul><li>Derived class has all properties and methods of base class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre></div><h3 id="extension-assignability" tabindex="-1"><a class="header-anchor" href="#extension-assignability" aria-hidden="true">#</a> Extension Assignability</h3><ul><li>An instance of a derived class can be assigned to a variable with base class type annotation.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span>
...
</code></pre></div><ul><li>If all properties and methods of a base class already exist on its derived class with same type, instances of that base class can be assigned to a variable with derived class type annotation.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
  a<span class="token operator">:</span> <span class="token builtin">number</span> <span class="token operator">=</span> <span class="token number">1</span>
<span class="token punctuation">}</span>
...
</code></pre></div><h3 id="overridden-methods" tabindex="-1"><a class="header-anchor" href="#overridden-methods" aria-hidden="true">#</a> Overridden Methods</h3><ul><li>Overridden methods in subclassed must be assignable to methods of base class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">SubClassThree</span> <span class="token keyword">extends</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="overridden-properties" tabindex="-1"><a class="header-anchor" href="#overridden-properties" aria-hidden="true">#</a> Overridden Properties</h3><ul><li>Overridden Property types in subclass must be assignable to property types in base class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
  a<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">number</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre></div><ul><li>Overridden properties are usually used to be narrowed to some more specific type in subclass.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">SubClass</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="abstract-classes" tabindex="-1"><a class="header-anchor" href="#abstract-classes" aria-hidden="true">#</a> Abstract Classes</h2><ul><li>A class that doesn&#39;t implement some methods.</li><li>Adding <code>abstract</code> keyword before a class or a method to indicates that is an abstract class.</li><li>TypeScript will throw error if abstract methods aren&#39;t implemented in subclass.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span>
...
<span class="token keyword">class</span> <span class="token class-name">Student</span> <span class="token keyword">extends</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><ul><li>Cannot create an instance of an abstract class.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">AbstractClass</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
</code></pre></div><h2 id="member-visibility" tabindex="-1"><a class="header-anchor" href="#member-visibility" aria-hidden="true">#</a> Member Visibility</h2><ul><li><code>public</code>: allowed to be accessed by anybody, anywhere</li><li><code>protected</code>: allowed to be accessed by the class itself and its subclass</li><li><code>private</code>: allowed to be accessed by the class itself</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">SubClass</span> <span class="token keyword">extends</span> <span class="token class-name">BaseClass</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><ul><li>A visibility keyword is positioned before the <code>readonly</code> keyword.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Base</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="static-field-modifiers" tabindex="-1"><a class="header-anchor" href="#static-field-modifiers" aria-hidden="true">#</a> Static Field Modifiers</h3><ul><li>static members are belong to a class rather than an instance.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Base</span> <span class="token punctuation">{</span>
...
</code></pre></div><ul><li>A visibility keyword comes first, then <code>static</code>, then <code>readonly</code>.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Base</span> <span class="token punctuation">{</span>
...
</code></pre></div>`,66),o=[e];function c(l,i){return s(),a("div",null,o)}const k=n(p,[["render",c],["__file","chapter_08.html.vue"]]);export{k as default};
