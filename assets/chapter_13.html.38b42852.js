...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p><em>data.json</em></p><div class="language-json ext-json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p><em>index.ts</em></p><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> name<span class="token punctuation">,</span> age <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./data.json&#39;</span>
...
</code></pre></div><ul><li>Default imports may be used if <code>resolveJsonModule</code> and <code>esModuleInterop</code> both are <code>true</code></li></ul><p><em>tsconfig.json</em></p><div class="language-json ext-json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">&quot;age&quot;</span><span class="token operator">:</span> <span class="token number">25</span>
<span class="token punctuation">}</span>
</code></pre></div><p><em>index.ts</em></p><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">import</span> data <span class="token keyword">from</span> <span class="token string">&#39;./data.json&#39;</span>
...
</code></pre></div><ul><li>If the JSON file contains literal types except <code>Object</code>, we will have to use the <code>* as import</code> syntax.</li></ul><p><em>data.json</em></p><div class="language-json ext-json"><pre class="language-json"><code><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span>
</code></pre></div><p><em>index.ts</em></p><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> numbers <span class="token keyword">from</span> <span class="token string">&#39;./data.json&#39;</span>
...
</code></pre></div><h2 id="emit" tabindex="-1"><a class="header-anchor" href="#emit" aria-hidden="true">#</a> Emit</h2><h3 id="outdir" tabindex="-1"><a class="header-anchor" href="#outdir" aria-hidden="true">#</a> outDir</h3><ul><li>By default, TypeScript places output files alongside their corresponding source files.</li></ul><div class="language-markdown ext-md"><pre class="language-markdown"><code>Before Compilation:
...
</code></pre></div><ul><li>Outputting to other directory by setting <code>outDir</code>.</li></ul><p><em>tsconfig.json</em></p><div class="language-json ext-json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;compilerOptions&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;outDir&quot;</span><span class="token operator">:</span> <span class="token string">&quot;dist&quot;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><div class="language-markdown ext-md"><pre class="language-markdown"><code>Before Compilation:
<span class="token list punctuation">-</span> src
...
<span class="token list punctuation">-</span> src
  ...
  <span class="token list punctuation">-</span> test-2
    <span class="token list punctuation">-</span> index.ts
</code></pre></div>`,61),p=[c];function i(l,r){return s(),a("div",null,p)}const u=n(o,[["render",i],["__file","chapter_13.html.vue"]]);export{u as default};
