import{_ as t,W as p,X as o,Y as n,Z as a,$ as e,a0 as c,C as i}from"./framework-0d71bc9d.js";const l={},u=c(`<h1 id="losing-this-keyword" tabindex="-1"><a class="header-anchor" href="#losing-this-keyword" aria-hidden="true">#</a> Losing <code>this</code> Keyword</h1><p><code>this</code> 由<strong>调用</strong>函数的上下文决定，不是由<strong>定义</strong>函数的上下文决定</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">fn</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
