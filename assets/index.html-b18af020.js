import{_ as i,W as o,X as c,Y as n,$ as a,a1 as l,Z as s,a0 as u,C as t}from"./framework-0d71bc9d.js";const r={},d=u(`<h1 id="mixins" tabindex="-1"><a class="header-anchor" href="#mixins" aria-hidden="true">#</a> Mixins</h1><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><ul><li><code>mixin</code> is an object for storing and reusing options of a vue instance.</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> mixinObj <span class="token operator">=</span> <span class="token punctuation">{</span>
