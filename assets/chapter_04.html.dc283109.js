import{_ as n,o as s,c as a,a as t}from"./app.0a43b3c6.js";const p={},e=t(`<h1 id="objects" tabindex="-1"><a class="header-anchor" href="#objects" aria-hidden="true">#</a> Objects</h1><h2 id="object-types" tabindex="-1"><a class="header-anchor" href="#object-types" aria-hidden="true">#</a> Object Types</h2><ul><li>TypeScript will throw error if accessing a non-exist property in object.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">const</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
obj<span class="token punctuation">.</span>a <span class="token comment">// Property &#39;a&#39; does not exist on type &#39;{}&#39;.</span>
</code></pre></div><h3 id="declaring-object-types" tabindex="-1"><a class="header-anchor" href="#declaring-object-types" aria-hidden="true">#</a> Declaring Object Types</h3><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">let</span> person<span class="token operator">:</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="aliased-object-types" tabindex="-1"><a class="header-anchor" href="#aliased-object-types" aria-hidden="true">#</a> Aliased Object Types</h3><ul><li>Using type alias to reuse object shape.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="structural-typing" tabindex="-1"><a class="header-anchor" href="#structural-typing" aria-hidden="true">#</a> Structural Typing</h2><h3 id="usage-checking" tabindex="-1"><a class="header-anchor" href="#usage-checking" aria-hidden="true">#</a> Usage Checking</h3><ul><li>TypeScript will throw an error if a required property is missing.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="excess-property-checking" tabindex="-1"><a class="header-anchor" href="#excess-property-checking" aria-hidden="true">#</a> Excess Property Checking</h3><ul><li>TypeScript will throw an error if a property is not defined in an object type but used.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="nested-object-types" tabindex="-1"><a class="header-anchor" href="#nested-object-types" aria-hidden="true">#</a> Nested Object Types</h3><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Book</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><ul><li>nested type alias</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Book</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token keyword">const</span> book1<span class="token operator">:</span> Book <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  name<span class="token operator">:</span> <span class="token string">&#39;Learning TypeScript&#39;</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="optional-properties" tabindex="-1"><a class="header-anchor" href="#optional-properties" aria-hidden="true">#</a> Optional Properties</h3><ul><li>Adding <code>?</code> before <code>:</code> to indicate that property is optional.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
...
</code></pre></div><h3 id="explicit-object-type-unions" tabindex="-1"><a class="header-anchor" href="#explicit-object-type-unions" aria-hidden="true">#</a> Explicit Object-Type Unions</h3><ul><li>Restricting access to potentially nonexistent members of objects.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">PersonWithAge</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
</code></pre></div><h3 id="narrowing-object-types" tabindex="-1"><a class="header-anchor" href="#narrowing-object-types" aria-hidden="true">#</a> Narrowing Object Types</h3><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Person</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="discriminated-unions" tabindex="-1"><a class="header-anchor" href="#discriminated-unions" aria-hidden="true">#</a> Discriminated Unions</h3><ul><li>Another popular form of union typed objects in JavaScript and TypeScript is to have a property on the object indicate what shape the object is.</li><li>This kind of type shape is called a <em>discriminated</em> union, and the property whose value indicates the object\u2019s type is a <em>discriminant</em>.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">StudentWithAge</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  name<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">,</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="intersection-types" tabindex="-1"><a class="header-anchor" href="#intersection-types" aria-hidden="true">#</a> Intersection Types</h2><ul><li>Intersection type is used to create a new type that combines multiple existing object types.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">TypeA</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><ul><li>Intersection types can be combined with union types.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">TypeA</span> <span class="token operator">=</span> <span class="token punctuation">{</span> a<span class="token operator">:</span> <span class="token builtin">string</span> <span class="token punctuation">}</span> <span class="token operator">&amp;</span> <span class="token punctuation">(</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="dangers-of-intersection-types" tabindex="-1"><a class="header-anchor" href="#dangers-of-intersection-types" aria-hidden="true">#</a> Dangers of Intersection Types</h3><ul><li>Trying to <code>&amp;</code> two primitives will result in the <code>never</code> type.</li></ul><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token comment">// TypeA is &#39;never&#39; type</span>
...
</code></pre></div>`,45),o=[e];function c(l,r){return s(),a("div",null,o)}const u=n(p,[["render",c],["__file","chapter_04.html.vue"]]);export{u as default};
